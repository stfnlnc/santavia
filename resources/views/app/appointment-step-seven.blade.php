            ...
            <form class="mt-8 flex flex-col items-center gap-8" action="{{ route('appointment.step-seven-submit') }}" method="POST">
                ...
                <div class="flex flex-col mt-8">
                    <div class="flex btn-outline mx-auto mt-8">
                        <input type="text" name="lastname" id="lastname" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="nom">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('lastname')"/>
                    <div class="flex btn-outline mx-auto mt-8">
                        <input type="text" name="firstname" id="firstname" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="prénom">
                    </div>
                    ...
                    <div class="flex btn-outline mx-auto">
                        <input type="date" name="birth" id="birth" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="date de naissance">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('birth')"/>
                    <div class="flex btn-outline mx-auto mt-8">
                        <input type="text" name="phone" id="phone" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="téléphone">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('phone')"/>
                    <div class="flex btn-outline mx-auto mt-8">
                        <input type="email" name="email" id="email" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="email">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('email')"/>
                    <div class="flex btn-outline mx-auto mt-8">
                        <input type="text" name="address" id="address" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="adresse de séjour">
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('address')"/>
                    <div class="flex btn-outline mx-auto mt-8">
                        <input type="text" name="nationality" id="nationality" class="text-2xl border-none w-80 neulis placeholder:text-black placeholder:font-bold" placeholder="nationalité">
                    </div>
