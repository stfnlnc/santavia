...
<div style="padding: 20px; background-color: #fce6d8; border-radius: 20px; text-align: center; max-width: 500px; margin: 0 auto;">
    <svg width="40" height="40" fill="#e174aa" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 568.64 486.9">
    ...
    <h1>Nouvelle prise de rendez-vous</h1>
    <p>
        Une nouvelle demande de rendez-vous est disponible sur votre tableau de bord.
    </p>
</div>
